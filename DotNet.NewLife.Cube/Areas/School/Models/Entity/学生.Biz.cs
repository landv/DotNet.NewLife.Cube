...
public partial class Student : Entity<Student>
{
    ...
    public static IList<Student> Search(Int32 tenantId, Int32 classId, DateTime start, DateTime end, String key, PageParameter page)
    {
        ...
        if (!key.IsNullOrEmpty()) exp &= _.Name.Contains(key) | _.Mobile.Contains(key) | _.Address.Contains(key) | _.Avatar.Contains(key) | _.CreateIP.Contains(key) | _.UpdateIP.Contains(key) | _.Remark.Contains(key);
